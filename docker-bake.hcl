...
target "provider-kubeadm-22-04-nvidia-minimal" {
  ...
  output = [
    "type=image,name=edgelabacr.azurecr.io/kairos/provider-kubeadm:22.04-0.3.0-agx-orin-minimal,push=true,compression=zstd,compression-level=17,force-compression=true"
  ]
}
